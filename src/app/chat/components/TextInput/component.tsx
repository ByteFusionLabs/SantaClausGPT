  ...
  return (
    <div className="overflow-hidden w-full h-full flex">
      <textarea
        value={value}
        id="messagesInput"
        className="p-4 w-full h-full bg-zinc-950 resize-none border-none align-top focus:ring-0 sm:text-sm"
        placeholder="Type your message here ..."
        onChange={onChange}
      ></textarea>
      <div className="h-full flex items-center justify-end gap-2 bg-zinc-950 p-3">
        <button
          type="button"
